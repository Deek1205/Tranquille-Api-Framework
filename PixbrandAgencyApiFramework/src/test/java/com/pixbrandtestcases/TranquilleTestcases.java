	    	 ...
	    	 RestAssured.baseURI = baseUrl;
				...
				Response res =RestAssured.
			       given().
					   ...
					   multiPart("demo_image[]", new File(imageURL), "multipart/form-data").
					auth()
					.oauth2(BarierToken)
					 .when()
			             .post(EndPointUrl3)
	    ...
	    public void vendorRegisterLogo() {
	    	 ...
	    	 RestAssured.baseURI = baseUrl;
				...
				Response res =RestAssured.
			       given().
					   contentType("multipart/form-data").
					   multiPart("logo", new File(imageURLLogo), "multipart/form-data").
					auth()
					.oauth2(BarierToken)
					 .when()
			             .post(EndPointUrl4)
